...
export const NAV_GROUPS: Array<{ title: string; theme: string; items: MenuEntry[] }> = [
  {
    ...
    items: [
      ...
      },
      {
        // 所有日期攤平成一張，預設只看未完成
        name: '出單總表',
        path: '/admin/argoerp/order-summary',
        icon: 'M3 10h18M3 14h18M4 6h16a1 1 0 011 1v10a1 1 0 01-1 1H4a1 1 0 01-1-1V7a1 1 0 011-1z',
      },
      {
        name: '追蹤清單',
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: '圖檔/PDF列印',
        path: '/admin/production/file-print',
  ...
  {
    // 報價系統（設計書寫 theme 'amber'，但 admin/layout.tsx 與 admin/page.tsx 的
    // 色票對照表只支援 cyan/purple/blue/orange/indigo/emerald，未支援的色會退回 cyan，
    // 故改用最接近且尚未被其他群組佔用的 'orange'）
    title: '報價系統',
    theme: 'orange',
    items: [
      {
        name: '品項維護',
        path: '/admin/quote/products',
        icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4',
      },
      {
        name: '材料價格表',
        path: '/admin/quote/prices',
        icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01',
      },
      {
        name: '全域參數',
