...
export default function ProcessGenPage() {
  ...
  // ── 自動轉換待處理清單（每日 17:30 排程跳過的列，導覽列徽章數字的明細）──
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 md:p-6 space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-0.5">由每日出單表 CSV 查詢途程，自動產出塔台 SARA_101 匯入格式・每日 17:30 自動轉換當日出單表</p>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl px-4 py-3">
        ...
        <p className="text-[10px] text-slate-600 mt-1.5">依「交期距今天數」自動填入 SARA 的 Priority Level（1-99，越大越優先）；手動產生與每日 17:30 自動轉換都套用此規則，超出最大天數的不填由塔台自行排程。</p>
      </div>
